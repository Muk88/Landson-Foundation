...
export default function EditAlumniPage({ params }: { params: { id: string } }) {
    ...
    if (loading) {
        return (
            <div className="flex justify-center p-12 w-full max-w-4xl mx-auto">
    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto w-full">
            <div className="mb-8 bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-heading font-black text-gray-900 tracking-tight">Edit Alumni</h1>
                    <p className="text-gray-500 mt-1">Update alumni profile details</p>
                </div>

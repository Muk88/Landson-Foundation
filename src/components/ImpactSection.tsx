                    ...
                    <div className="space-y-12">
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-white leading-tight">
                                Transforming Lives Through <span className="text-brand-red underline decoration-white/20 underline-offset-8">Athletics</span> and Education
                            </h2>
                            <p className="text-white/80 text-lg md:text-xl leading-relaxed max-w-xl">
                                We believe that every talented young athlete deserves the opportunity to pursue both their athletic dreams and academic excellence. In Nandi County, we're building a future where talent meets opportunity.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={item.label} className="flex flex-col items-center sm:items-start space-y-2 group">
                                    ...
                                    <span className="text-4xl lg:text-5xl font-heading font-black text-white">{item.value}</span>
                                    <span className="text-white/60 text-sm font-bold uppercase tracking-wider">{item.label}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 h-[500px] sm:h-[600px]">
                        <div className="space-y-4 pt-12">
                            ...
                            <div className="relative h-1/3 rounded-2xl overflow-hidden shadow-2xl bg-brand-red p-8 flex items-end">
                                <p className="text-white font-heading font-bold text-2xl leading-tight">Rooted in Excellence.</p>
                            </div>
                        </div>
